...
export const isR2Configured = Boolean(accountId && accessKeyId && secretAccessKey && bucketName && publicUrl);
 ...
 */
export async function uploadToR2(buffer, fileName, contentType = "application/octet-stream") {
