...
router.put("/:id", async (req, res) => {
    try {
        ...
        const r = req.body;
        const trim = (v) => (typeof v === "string" ? v.trim() || null : undefined);
        const data = {};
        const fields = [
        ...
        if ("blocked" in r)
            data.blocked = Boolean(r.blocked);
...
router.patch("/bulk/blocklist", async (req, res) => {
    try {
...
router.post("/bulk/lists", async (req, res) => {
    try {
